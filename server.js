...
app.all('/api/ai/studio', route(studioHandler, studioMethods));
app.all('/api/ai/image', route(imageHandler, imageMethods));
app.all('/api/growth', route(growthHandler, growthMethods));
app.all('/api/email/test', route(emailTestHandler, emailTestMethods));
